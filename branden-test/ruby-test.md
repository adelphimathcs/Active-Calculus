...
On the left-hand axes provided in Figure \[F:4.1.PA1\], sketch a labeled
graph of the velocity function $v(t) = 3$.

![At left, axes for plotting $y = v(t)$; at right, for plotting
$y = s(t)$.<span data-label="F:4.1.PA1"></span>](figures/4_1_PA1.eps)
...
For what values of $t$ is the position function $s$ increasing? Explain
...
Compute the value of $s(1) - s(\frac{1}{2})$. What is the meaning of the
value you find?

Using the graph of $y = v(t)$ provided in Figure \[F:4.1.Act2\], find
the exact area of the region under the velocity curve between
...
What is the value of $s(2) - s(0)$? What does this result tell you about
...
Approximately how far north of Pigeon Lake was the cyclist when she was
...
What is the total distance the biker traveled on $0 \le t \le 4$? At the
end of the ride, how close was she to the point at which she started?

Sketch an approximate graph of $y = s(t)$, the position function of the
...
What is the value and meaning of $s(5) - s(2)$, where $y = s(t)$ is the
