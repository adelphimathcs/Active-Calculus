\section{Determining distance traveled from
...
\addcontentsline{toc}{subsection}{Area under the graph of the velocity
function}
...
\addcontentsline{toc}{subsection}{Two approaches: area and
antidifferentiation}
...
{[}A:4.1.2{]} A ball is tossed vertically in such a way that its
...
\addcontentsline{toc}{subsection}{When velocity is negative}
