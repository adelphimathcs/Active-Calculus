...
{% include images.md path="figures/4_1_PA1Soln.png" caption="The velocity function $v(t) = 3$ and corresponding position function $s(t) = 3t$.<span" label="F:4.1.PA1Soln" %}
